...
def astros():
    Astros  = [
        ...
        {'name': "Oleg Kotov",        'craft': "ISS"},
        {'name': "Michael Hopkins",   'craft': "ISS"},
        {'name': "Koichi Wakata",     'craft': "Soyuz TMA-11M"},
        {'name': "Richard A. Mastracchio", 'craft': "Soyuz TMA-11M"},
        {'name': "Mikhail Tyurin",    'craft': "Soyuz TMA-11M"},
    ]
